      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
        <ScrollReveal>
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-4xl sm:text-5xl font-normal text-charcoal">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-border px-8 py-4 text-base font-medium text-charcoal hover:bg-white transition-colors"
              >

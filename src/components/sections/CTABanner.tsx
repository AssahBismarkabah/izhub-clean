          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-border px-8 py-4 text-[15px] font-medium text-charcoal hover:bg-white transition-colors"
              >

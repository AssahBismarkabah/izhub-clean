  ...
  return (
    <section className="relative overflow-hidden bg-white pt-32 pb-20 lg:pt-44 lg:pb-32">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[500px] rounded-full bg-gradient-to-br from-red-100/40 via-orange-100/30 to-purple-100/40 blur-[100px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            <br />
            that{" "}
            <span className="text-gradient font-medium">earns your trust</span>
          </motion.h1>
        ...
        <motion.div
          ...
          className="mt-24 grid grid-cols-2 gap-8 sm:grid-cols-4 border-t border-border pt-10"
        >
          {[

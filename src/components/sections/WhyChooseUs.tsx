          ...
          <div className="mt-20 grid gap-10 lg:grid-cols-2 lg:items-center">
            <div>
              <Image
                ...
                width={600}
                height={500}
                className="rounded-[20px] object-cover w-full aspect-[5/4] shadow-[0_8px_30px_rgba(0,0,0,0.06)]"
              />
            </div>
            <div>
              ...
              <Link
                ...
                className="mt-7 inline-flex items-center gap-2 text-[15px] font-medium text-charcoal hover:gap-3 transition-all"
              >
